...
def get_session(args):
    ...
    if args.username and args.password:
        LOGGER.debug('HTTP basic authentication: %s' % (args.username))
        session.auth = (args.username + '#admin', args.password)
    elif args.certificate and args.private_key:
        LOGGER.debug('HTTPS X.509 grid authentication: (%s,%s)' % (args.certificate, args.private_key))
        session.cert = (
            full_path(args.certificate),
            full_path(args.private_key))
    elif args.x509_proxy:
        LOGGER.debug('HTTPS X.509 grid proxy authentication: %s' % (args.x509_proxy))
        session.cert = full_path(args.x509_proxy)
    else:
    ...
    elif args.ca_certificate:
        LOGGER.debug('CA certificate: %s' % args.ca_certificate)
        session.verify = args.ca_certificate
    elif args.ca_directory:
        LOGGER.debug('CA directory: %s' % args.ca_directory)
...
def query(args, url, operation='get', params=None, data=None):
    '''
    '''
    with get_session(args) as session:
        ...
        response = operation_mapping[operation](url, params=params, data=data)
...
def path_completer(prefix, parsed_args, **kwargs):
    ...
    url = parsed_args.url + '/api/v1/namespace/'
    url += path
    response = query(parsed_args, url, params={'children': True})
    paths = []
...
def pool_completer(prefix, parsed_args, **kwargs):
    ...
    """
    url = parsed_args.url + '/api/v1' + '/pools'
    response = query(parsed_args, url)
...
def pool_group_completer(prefix, parsed_args, **kwargs):
    ...
    """
    url = parsed_args.url + '/api/v1' + '/poolgroups'
    response = query(parsed_args, url)
...
def cell_address_completer(prefix, parsed_args, **kwargs):
    ...
    """
    url = parsed_args.url + '/api/v1' + '/cells/addresses'
    response = query(parsed_args, url)
    return [cell_address for cell_address in response]



def get_qos_list(args):
    """
    ...
    url = args.url + '/api/v1' + '/qos-management/qos/{type}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_queried_qos_for_files(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/qos-management/qos/file/{qos}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_queried_qos_for_directories(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/qos-management/qos/directory/{qos}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def channel_metadata(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{id}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def delete(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{id}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="delete")
    print_response(response)
...
def modify(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{id}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="patch")
    print_response(response)
...
def get_channels(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def register(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="post")
    print_response(response)


def channel_subscription(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{channel_id}/subscriptions/{type}/{subscription_id}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def subscribe(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{id}/subscriptions/{type}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="post")
    print_response(response)


def channel_subscriptions(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/channels/{id}/subscriptions'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_event_types(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/eventTypes'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_selector_schema(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/eventTypes/{type}/selector'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_event_schema(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/eventTypes/{type}/event'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def service_metadata(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_event_type(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/events/eventTypes/{type}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_priority(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/alarms/priorities/{type}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_alarms(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/alarms/logentries'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def bulk_update_or_delete(args):
    """
...
def delete_alarm_entry(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/alarms/logentries/{key}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="delete")
    print_response(response)


def update_alarm_entry(args):
    """
...
def get_priorities(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/alarms/priorities'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_data(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/histograms/{key}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_p2ps(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/p2ps/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_reads(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/reads/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_restores(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/restores/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_stores(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/stores/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_writes(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/writes/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_grid(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/histograms/grid/description'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_grid_data(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/billing/histograms'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_cells(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/cells'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_cell_data(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/cells/{address}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_addresses(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/cells/addresses'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_user_attributes(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/user'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_file_attributes(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/namespace/{path}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def cmr_resources(args):
    """
...
def get_attributes(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/id/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_pool_groups(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_pool_group(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_pools_of_group(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/pools'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_group_usage(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/usage'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_queue_info(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/queues'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_space_info(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/space'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_queue_histograms(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/histograms/queues'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_files_histograms(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/poolgroups/{group}/histograms/files'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_pool(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_movers(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/movers'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_queue_histograms(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/histograms/queues'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_files_histograms(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/histograms/files'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_pool_usage(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/usage'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_repository_info_for_file(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/{pnfsid}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_nearline_queues(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/nearline/queues'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def kill_movers(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/movers/{id}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="delete")
    print_response(response)
...
def update_mode(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools/{pool}/usage/mode'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="patch")
    print_response(response)
...
def get_pools(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pools'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_restores(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/restores'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_links(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/links'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_link_groups(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/links/groups'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_partitions(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/partitions'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def match(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/pool-preferences'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_units(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/units'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_unit_groups(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/units/groups'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)


def get_tokens_for_group(args):
    """
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/space/tokens'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_link_groups(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/space/linkgroups'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def get_transfers(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    url = args.url + '/api/v1' + '/transfers'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="get")
    print_response(response)
...
def bring_online(args):
    ...
    for attr in attrs:
        params[attr] = getattr(args, attr)
    data = '{"action": "qos", "target": "disk+tape"}'
    url = args.url + '/api/v1' + '/namespace/{path}'.format(**vars(args))
    response = query(args, url, data=data, params=params, operation="post")
    print_response(response)
...
def get_parser(config):
    ...
    getPriority_parser.set_defaults(func=get_priority)
    ...
    getAlarms_parser.set_defaults(func=get_alarms)
    ...
    bulkUpdateOrDelete_parser.set_defaults(func=bulk_update_or_delete)
    ...
    deleteAlarmEntry_parser.set_defaults(func=delete_alarm_entry)
    ...
    updateAlarmEntry_parser.set_defaults(func=update_alarm_entry)
    ...
    getPriorities_parser.set_defaults(func=get_priorities)
    ...
    getData_parser.set_defaults(func=get_data)
    ...
    getP2ps_parser.set_defaults(func=get_p2ps)
    ...
    getReads_parser.set_defaults(func=get_reads)
    ...
    getRestores_parser.set_defaults(func=get_restores)
    ...
    getStores_parser.set_defaults(func=get_stores)
    ...
    getWrites_parser.set_defaults(func=get_writes)
    ...
    getGrid_parser.set_defaults(func=get_grid)
    ...
    getGridData_parser.set_defaults(func=get_grid_data)
    # The cells subparser
    ...
    getCells_parser.set_defaults(func=get_cells)
    ...
    getCellData_parser.set_defaults(func=get_cell_data)
    ...
    getAddresses_parser.set_defaults(func=get_addresses)
    ...
    getUserAttributes_parser.set_defaults(func=get_user_attributes)
    ...
    getFileAttributes_parser.set_defaults(func=get_file_attributes)
    ...
    cmrResources_parser.set_defaults(func=cmr_resources)
...
If action is 'qos' then the value of the JSON object 'target' item describes the desired QoS.""", action='store')
    ...
    deleteFileEntry_parser.set_defaults(func=delete_file_entry)
    ...
    getAttributes_parser.set_defaults(func=get_attributes)
    ...
    getPoolGroups_parser.set_defaults(func=get_pool_groups)
    ...
    getPoolGroup_parser.set_defaults(func=get_pool_group)
    ...
    getPoolsOfGroup_parser.set_defaults(func=get_pools_of_group)
    ...
    getGroupUsage_parser.set_defaults(func=get_group_usage)
    ...
    getQueueInfo_parser.set_defaults(func=get_queue_info)
    ...
    getSpaceInfo_parser.set_defaults(func=get_space_info)
    ...
    getQueueHistograms_parser.set_defaults(func=get_queue_histograms)
    ...
    getFilesHistograms_parser.set_defaults(func=get_files_histograms)
    ...
    getLinks_parser.set_defaults(func=get_links)
    ...
    getLinkGroups_parser.set_defaults(func=get_link_groups)
    ...
    getPartitions_parser.set_defaults(func=get_partitions)
    ...
    getUnits_parser.set_defaults(func=get_units)
    ...
    getUnitGroups_parser.set_defaults(func=get_unit_groups)
    # The pools subparser
    ...
    getPool_parser.set_defaults(func=get_pool)
    ...
    getMovers_parser.set_defaults(func=get_movers)
    ...
    getPoolUsage_parser.set_defaults(func=get_pool_usage)
    ...
    getRepositoryInfoForFile_parser.set_defaults(func=get_repository_info_for_file)
    ...
    getNearlineQueues_parser.set_defaults(func=get_nearline_queues)
    ...
    killMovers_parser.set_defaults(func=kill_movers)
    ...
    updateMode_parser.set_defaults(func=update_mode)
    ...
    getPools_parser.set_defaults(func=get_pools)
    ...
    getQosList_parser.set_defaults(func=get_qos_list)
    ...
    getQueriedQosForFiles_parser.set_defaults(func=get_queried_qos_for_files)
    ...
    getQueriedQosForDirectories_parser.set_defaults(func=get_queried_qos_for_directories)
    ...
    getTokensForGroup_parser.set_defaults(func=get_tokens_for_group)
    ...
    getTransfers_parser.set_defaults(func=get_transfers)
    ...
    channelMetadata_parser.set_defaults(func=channel_metadata)
    ...
    getChannels_parser.set_defaults(func=get_channels)
    ...
    channelSubscription_parser.set_defaults(func=channel_subscription)
    ...
    channelSubscriptions_parser.set_defaults(func=channel_subscriptions)
    ...
    getEventTypes_parser.set_defaults(func=get_event_types)
    ...
    getSelectorSchema_parser.set_defaults(func=get_selector_schema)
    ...
    getEventSchema_parser.set_defaults(func=get_event_schema)
    ...
    serviceMetadata_parser.set_defaults(func=service_metadata)
    ...
    getEventType_parser.set_defaults(func=get_event_type)
